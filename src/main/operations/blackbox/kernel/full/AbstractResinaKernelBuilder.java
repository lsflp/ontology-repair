...
/**
 * Represents a generic algorithm for computing the full kernel set.
 *
 * @author Raphael M. Cóbe (adapted by Vinícius B. Matos and Luís F. de M. C. Silva)
 */
public abstract class AbstractResinaKernelBuilder extends OperatorStrategy {
     ...
     */
    protected AbstractResinaKernelBuilder(AbstractBlackBox blackBox, OWLOntologyManager manager,
